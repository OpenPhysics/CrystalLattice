/**
 * crystalLatticeQueryParameters.ts
 *
...
CrystalLatticeNamespace.register("crystalLatticeQueryParameters", crystalLatticeQueryParameters);

// Log query parameters (for the console / PhET-iO).
logGlobal("phet.chipper.queryParameters");

export default crystalLatticeQueryParameters;
