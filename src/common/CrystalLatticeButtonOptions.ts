/**
 * CrystalLatticeButtonOptions.ts
 *
...
export const LIGHT_SURFACE_TEXT_FILL = CrystalLatticeColors.controlSurfaceTextColorProperty;

/**
 * Combo-box chrome for panels. Item labels must use {@link LIGHT_SURFACE_TEXT_FILL}, not
 * {@link CrystalLatticeColors.textColorProperty} — that color is for labels on the dark panel fill.
 */
export const CRYSTAL_LATTICE_COMBO_BOX_OPTIONS = {
  buttonFill: CrystalLatticeColors.controlSurfaceColorProperty,
  listFill: CrystalLatticeColors.controlSurfaceColorProperty,
  buttonStroke: CrystalLatticeColors.panelBorderColorProperty,
  listStroke: CrystalLatticeColors.panelBorderColorProperty,
...
export const TIME_CONTROL_SPEED_RADIO_OPTIONS = {
  speedRadioButtonGroupOptions: {
    labelOptions: { fill: CrystalLatticeColors.textColorProperty },
  },
